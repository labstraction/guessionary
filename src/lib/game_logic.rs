...
use crate::lib::model::{
    dictionary::find_word,
    game_history::record_status,
    status::{get_status_distance, next_status},
};
use termion::clear;

use super::model::{
    dictionary::{get_bottom_word, get_random_word, get_top_word, new_dictionary},
...
pub fn new_game(language: &str, _difficulty: &str) {
    ...
    loop {
        println!(
            "La tua parola è tra {} e {} e ci sono {} parole possibili",
